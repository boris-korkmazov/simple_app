...
RSpec.describe User, type: :model do
  ...
  before {
    @user = User.new(name:"Example User", email: "user@example.com", 
                          password:"foobarqw", password_confirmation:"foobarqw") 
  }
  ...
  describe "when email is to long" do
    before { @user.email = 'a'*50 + "@mail.ru"}
    it { should_not be_valid }
  end
  ...
  describe "when email address is downcase mode" do
    let(:mixed_case_email) { "WEQWEsdsad@asdasW.COM"}
  ...
  describe "micropost associations" do
    ...
    describe "status" do 
      ...
      it "should include followed post" do
